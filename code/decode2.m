...
%
% 
% (c) 2011 Template by Frank Rudzicz 
...
SS = AM.( DEFINITIONS.SENTSTART );
SE = AM.( DEFINITIONS.SENTEND );
AM = rmfield(AM, DEFINITIONS.SENTSTART );
AM = rmfield(AM, DEFINITIONS.SENTEND );
VE = fieldnames(AM);
AM.(DEFINITIONS.SENTSTART ) = SS;
AM.(DEFINITIONS.SENTEND ) = SE;
